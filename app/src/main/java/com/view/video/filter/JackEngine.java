...
public class JackEngine extends FilterEngine{

    public JackEngine(int OESTextureId) {
        super(OESTextureId);
    }
    ...
    public String getFragment() {
        return "#extension GL_OES_EGL_image_external : require\n" +
                ...
                "  float fGrayColor = (0.6*vCameraColor.r + 0.19*vCameraColor.g + 0.11*vCameraColor.b);\n" +
