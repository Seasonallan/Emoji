...
public class DelView {
    ...
    public boolean checkPosition(MotionEvent event) {
        ...
        ValueAnimator fadeAnim = ObjectAnimator.ofFloat(del_container, "translationY", -del_container.getHeight(), 0);
    ...
    void show(View view){
        ...
        ValueAnimator fadeAnim = ObjectAnimator.ofFloat(view, "alpha", 0, 1);
        fadeAnim.setInterpolator(new DecelerateInterpolator());
        fadeAnim.setDuration(300);
        fadeAnim.start();
    }
    ...
    public void hide() {
        ...
        show(view2);
        show(view3);
        ValueAnimator fadeAnim = ObjectAnimator.ofFloat(del_container, "translationY", 0, -del_container.getHeight());
        fadeAnim.setInterpolator(new DecelerateInterpolator());
        fadeAnim.setDuration(300);
        fadeAnim.addListener(new Animator.AnimatorListener() {
            @Override
            ...
            @Override
            public void onAnimationEnd(Animator animation) {
                del_container.setVisibility(View.INVISIBLE);
            }
